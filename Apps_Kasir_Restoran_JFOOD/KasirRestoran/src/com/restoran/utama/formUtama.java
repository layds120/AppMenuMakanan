...
public class formUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/restoran/gambar/Paper Art Of Fuji Mountain Background Vector.jpg"))); // NOI18N
        ...
        makanan.add(btn_simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 340, -1, -1));

        jLabel1.setFont(new java.awt.Font("Imprint MT Shadow", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 102, 102));
        jLabel1.setText("PAKET MAKANAN J*FOOD");
        makanan.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, -1, -1));
        ...
        makanan.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 290, 80, -1));
        ...
        makanan.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 390, -1, -1));

        jLabel4.setText("Harga");
        makanan.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, -1, -1));

        txtidmakanan.setBackground(new java.awt.Color(255, 204, 204));
        txtidmakanan.setForeground(new java.awt.Color(255, 255, 255));
        txtidmakanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtidmakananActionPerformed(evt);
            }
        });
        makanan.add(txtidmakanan, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 110, 220, 30));

        jLabel2.setText("Paket Makanan");
        makanan.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 80, -1, -1));

        jLabel3.setText("Nama Paket Makanan");
        makanan.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, -1, -1));

        tbl_makanan.setBackground(new java.awt.Color(255, 204, 204));
        tbl_makanan.setForeground(new java.awt.Color(255, 255, 255));
        ...
        makanan.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, 450, 179));
        ...
        makanan.add(txtharga, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 220, 30));

        txtnamapaket.setBackground(new java.awt.Color(255, 204, 204));
        txtnamapaket.setForeground(new java.awt.Color(255, 255, 255));
        makanan.add(txtnamapaket, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 220, -1));

        jLabel5.setText("Keterangan");
        makanan.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 150, -1, -1));
        ...
        makanan.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 190, 220, 70));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/restoran/gambar/Paper Art Of Fuji Mountain Background Vector.jpg"))); // NOI18N
        makanan.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 630));

        jLabel10.setText("jLabel10");
        makanan.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 120, 170, 100));
        ...
        transaksi.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 110, -1, -1));

        jLabel13.setText("No Transaksi");
        transaksi.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, -1, -1));

        jLabel14.setText("Kode Paket Makanan");
        transaksi.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, -1));

        jLabel15.setText("Nama Paket");
        transaksi.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, -1));

        jLabel16.setText("Harga");
        transaksi.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, -1));

        jLabel17.setText("Jumlah");
        transaksi.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, -1, -1));

        tgl_transaksi.setEditable(false);
        tgl_transaksi.setBackground(new java.awt.Color(255, 204, 204));
        tgl_transaksi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tgl_transaksiActionPerformed(evt);
            }
        });
        transaksi.add(tgl_transaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 140, 250, -1));

        txt_no_transaksi.setEditable(false);
        txt_no_transaksi.setBackground(new java.awt.Color(255, 204, 204));
        transaksi.add(txt_no_transaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, 93, -1));

        txt_nama_paket.setBackground(new java.awt.Color(255, 204, 204));
        txt_nama_paket.setEnabled(false);
        transaksi.add(txt_nama_paket, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 250, -1));

        cmb_kode.setBackground(new java.awt.Color(255, 204, 204));
        cmb_kode.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmb_kodeItemStateChanged(evt);
            }
        });
        transaksi.add(cmb_kode, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 250, -1));

        txt_jumlah_t.setBackground(new java.awt.Color(255, 204, 204));
        ...
        transaksi.add(txt_jumlah_t, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 250, -1));

        txt_harga_t.setBackground(new java.awt.Color(255, 204, 204));
        txt_harga_t.setEnabled(false);
        transaksi.add(txt_harga_t, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 250, -1));
        ...
        transaksi.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 360, -1, -1));
        ...
        transaksi.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 495, 95));
        transaksi.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 590, 30));

        jLabel6.setFont(new java.awt.Font("Imprint MT Shadow", 0, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 102, 102));
        jLabel6.setText("TRANSAKSI MAKANAN J*FOOD");
        transaksi.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, -1, -1));
        ...
        transaksi.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 240, 200, -1));

        txt_id_kasir.setEditable(false);
        transaksi.add(txt_id_kasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 20, 50, -1));

        txt_total_semua.setEditable(false);
        txt_total_semua.setBackground(new java.awt.Color(255, 204, 204));
        transaksi.add(txt_total_semua, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 450, 200, -1));

        jLabel18.setText("Total");
        transaksi.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 450, -1, -1));
        ...
        transaksi.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 400, -1, -1));
        ...
        transaksi.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 450, -1, -1));

        jLabel7.setText("Id Admin");
        transaksi.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 20, -1, -1));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/restoran/gambar/Paper Art Of Fuji Mountain Background Vector.jpg"))); // NOI18N
        transaksi.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 630));

        getContentPane().add(transaksi, "card4");

        jMenuBar1.setBackground(new java.awt.Color(255, 102, 102));

        jMenu2.setForeground(new java.awt.Color(255, 153, 153));
        jMenu2.setText("Makanan");

        jMenuItem4.setForeground(new java.awt.Color(255, 153, 153));
        ...
        jMenu3.setForeground(new java.awt.Color(255, 153, 153));
        ...
        jMenuItem2.setForeground(new java.awt.Color(255, 153, 153));
        ...
        jMenuItem3.setForeground(new java.awt.Color(255, 153, 153));
